...
# ── Default photo path ────────────────────────────────────────────────────────
DEFAULT_PHOTO = None   # e.g. "/home/pi/pics/family.jpg"
...
def main():
    ...
    # ── Resolve photo ──────────────────────────────────────────────────────────
    photo_path = args.photo or DEFAULT_PHOTO
    if not args.no_picker and not args.photo:
        picked = browse_image_qt(picdir if os.path.isdir(picdir)
                                  else os.path.expanduser("~"))
        photo_path = picked or photo_path
